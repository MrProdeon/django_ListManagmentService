...
urlpatterns = [
    ...
    path(
        "update_recipient/<int:pk>/", UpdateRecipient.as_view(), name="update_recipient"
    ),
    path(
        "delete_recipient/<int:pk>/", DeleteRecipient.as_view(), name="delete_recipient"
    ),
    path(
        "detail_recipient/<int:pk>/", DetailRecipient.as_view(), name="detail_recipient"
    ),
    # USERS
    ...
    path(
        "register/succes_verify/",
        TemplateView.as_view(template_name="success_verify.html"),
        name="success_verify",
    ),
